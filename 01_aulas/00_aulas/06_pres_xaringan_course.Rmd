...
subtitle: "6 Visualização de dados<br><br><br>"
...
## Tópicos
6.1 Principais pacotes para gráficos no R
<br>
6.2 Colunas como eixos dos gráficos
<br>
6.3 Principais tipos de gráficos (tipos de variáveis)
<br>
6.4 Histograma (histogram)
<br>
6.5 Gráfico de caixa (box plot)
<br>
6.6 Gráfico de barras (bar plot)
<br>
6.7 Gráfico de dispersão (scatter plot)
...
# 6.2 Colunas como eixos do gráficos
...
# 6.2 Colunas como eixos (tipos de variáveis)
...
# 6.3 Principais tipos de gráficos
...
## 6. Façam um histograma das colunas `effort_months`, `altitude`, `temperatura`, `precipitation` utilizando os pacotes **graphics** e **ggplot2**
