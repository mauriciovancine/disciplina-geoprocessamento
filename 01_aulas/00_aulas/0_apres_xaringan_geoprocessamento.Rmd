...
<br>
7.8 Cálculo de área, perímetro e distância de dados vetoriais
<br>
7.9 Criação de dados vetoriais
<br>
7.10 Edição de dados vetoriais
<br>
7.11 Geoprocessamento de dados vetoriais
<br>
7.12 Fotointerpretação de imagens
<br>
7.13 Verificação geométrica e ajuste topológico
<br>
7.14 Reprojeção de dados vetoriais
<br>
7.15 Exportar dados vetoriais
...
### 7 Introdução e funcionamento do software QGIS (terça - quarta)
7.16 Adicionar dados matriciais preexistentes
<br>
7.17 Propriedades de dados matriciais
<br>
7.18 Georreferenciamento de dados matriciais
<br>
7.19 Mosaico (união de imagens)
<br>
7.20 Recorte (extração de máscara)
<br>
7.21 Alinhar raster (extensão e resolução)
<br>
7.22 Análises de superfície (mapas de calor, interpolação, proximidade)
<br>
7.23 Estatística zonal
<br>
7.24 Calculadora raster
<br>
7.25 Conversão de dados vetoriais e dados matriciais
<br>
7.26 Reprojeção de dados matriciais
<br>
7.27 Exportar dados matriciais
...
7.28 Sensoriamento Remoto (bandas espectrais – composição e extração)
<br>
7.29 Classificação supervisionada
<br>
7.30 Índices de vegetação (NDVI/EVI)
<br>
7.31 Topografia (MDE, MDS, MDT, elevação, declividade, aspecto, hidrologia)
<br>
7.32 Elaboração de mapa temáticos
