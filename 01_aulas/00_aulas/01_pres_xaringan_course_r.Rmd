...
subtitle: "1 Linguagem R, aplicações e material <br><br><br>"
...
O [Manual do R](https://cran.r-project.org/doc/manuals/r-release/R-intro.pdf)<sup>1</sup> define o R como um **ambiente de programação**, com um conjunto integrado de ferramentas para **manipulação de dados, cálculos e apresentação gráfica** (**Venables et al. 2018**)

<br>

[1] [Venables et al. 2008](https://cran.r-project.org/doc/manuals/r-release/R-intro.pdf)
...
background-image: url(https://pbs.twimg.com/profile_images/1061862561509924864/EoHCtCI3_400x400.jpg)
background-size: 250px
...
[Belo Horizonte, Minas Gerais – Brazil](https://www.meetup.com/pt-BR/rladies-belo-horizonte/)

[Rio de Janeiro, Rio de Janeiro – Brazil](https://www.meetup.com/pt-BR/rladies-rio/)
...
background-image: url(http://www-bcf.usc.edu/~gareth/ISL/ISL%20Cover%202.jpg)
